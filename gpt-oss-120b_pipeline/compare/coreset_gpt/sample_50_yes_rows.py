...
DEFAULT_INPUT = SCRIPT_DIR.parents[1] / "results_gpt-oss-120b.csv"
DEFAULT_OUTPUT = SCRIPT_DIR / "gpt-120_50_yes_rows.csv"


def parse_args():
    parser = argparse.ArgumentParser(
        description="Sample 50 rows from results_gpt-oss-120b.csv where model_answer is Yes."
    )
    parser.add_argument(
        "--input",
        type=Path,
